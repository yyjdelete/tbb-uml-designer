...
namespace UMLDes.GUI {
	...
	public class GuiConnectionPoint:GuiPoint,ISelectable,IMoveable,IStateObject {
		...
		[XmlIgnore]
		public IAcceptConnection item;
		[XmlIgnore]
		public GuiBoundString role;
		...
		bool Hyphen {
			get {
				return hyphen && ((GuiConnection) root).CanHaveHyphen;
			}
		}
		[XmlIgnore]
		internal Geometry.Direction hyphen_dir = Geometry.Direction.Null;
		[XmlIgnore]
		int hx,hy;
