...
namespace UMLDes.GUI {
	...
	public class StaticView:View,IPostload,IUndoNotification {
		...
		// list of GuiObject
		[XmlIgnore]
		public SelectionList SelectedObjects = new SelectionList ();  // list of GuiObject

		// Has of IHasID
		[XmlIgnore]
		public Hashtable gui_objects = new Hashtable ();

		[XmlIgnore]
		public int width,height;
		[XmlIgnore]
		public StaticViewUndo Undo;
		[XmlIgnore]
		public override Undo undo {
			get {
				return Undo;
			}
		}
		...
		public double CallCalculate (out int lineNum,out int packageNum,out int classNum) {
			return Calculate.DoCalculate (this,out lineNum,out packageNum,out classNum);
		}
