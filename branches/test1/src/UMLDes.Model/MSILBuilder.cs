...
namespace UMLDes.Model.MSIL {
	...
	public class ModelBuilder {
		...
		public static UmlProject CreateProjectFromName (string name) {
			//原版		System.Reflection.Assembly assem = System.Reflection.Assembly.LoadWithPartialName(name);
			//新版用法 yyj
			System.Reflection.Assembly assem = System.Reflection.Assembly.Load (name);
			if (assem == null)
				return null;
			UmlProject proj = new UmlProject ();
