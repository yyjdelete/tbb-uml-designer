...
namespace UMLDes.Model {
	...
	public abstract class UmlMember:UmlObject {
		...
		[XmlAttribute]
		public bool IsAbstract,IsStatic;

		#region 方法

		public abstract UmlMemberKind MemberKind {
			get;
		}
	...
	public class UmlField:UmlMember {
		...
		public override UmlKind Kind {
			get {
				return UmlKind.Field;
			}
		}
		public override UmlMemberKind MemberKind {
			get {
				return UmlMemberKind.Attributes;
			}
		}
	...
	public class UmlMethod:UmlMember {
		...
		[XmlElement ("Parameter",typeof (UmlParameter))]
		...
		public override UmlKind Kind {
			get {
				return UmlKind.Method;
			}
		}
		public override UmlMemberKind MemberKind {
			get {
				return UmlMemberKind.Operations;
			}
		}
	...
	public class UmlProperty:UmlMember {
		[XmlAttribute]
		public string Type,Accessors;

		#region 方法

		public override UmlKind Kind {
			get {
				return UmlKind.Property;
			}
		}
		public override UmlMemberKind MemberKind {
			get {
				return UmlMemberKind.Properties;
			}
		}
