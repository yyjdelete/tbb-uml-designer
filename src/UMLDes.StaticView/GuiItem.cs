...
namespace UMLDes.GUI {
	...
	public abstract class GuiItem:GuiActive,IAcceptConnection,IHyphenSupport,IAroundObject {
		...
		[XmlIgnore]
		public ArrayList cpoints = new ArrayList ();
		...
		public abstract Rectangle AroundRect {
			get;
		}
		...
		[XmlIgnore]
		public abstract Point[] con_points {
			get;
		}
		[XmlIgnore]
		public abstract Point[] con_edges {
			get;
		}
