...
namespace UMLDes.GUI {
	...
	public class GuiMember:ICloneable {
		[XmlAttribute]
		public string signature,stereo,constraint;
		[XmlAttribute]
		public bool visible;
	...
	public class GuiClass:GuiRectangle,IStateObject,IDropMenu,IHasStereotype {
		...
		[XmlAttribute]
		public bool show_members = true,show_vars = true,show_properties = true,show_only_public = false;
		[XmlAttribute]
		public bool show_full_qual = false,show_method_signatures = false;
		[XmlElement ("member_params",typeof (GuiMember))]
